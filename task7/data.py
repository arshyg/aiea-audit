...
course_rules = (
    IF(AND('(?x) completed cs101', '(?x) completed cs101m'),
       THEN('(?x) eligible-for cs102')),

    IF(AND('(?x) eligible-for cs102', '(?x) completed math101'),
       THEN('(?x) eligible-for cs201')),
)

course_data = [
    'sluggy completed cs101',
    'sluggy completed cs101m',
    'sluggy completed cs102',
    'sluggy completed math101',
    'bob completed cs101',
    'anna completed cs101',
    'anna completed math101',
]
